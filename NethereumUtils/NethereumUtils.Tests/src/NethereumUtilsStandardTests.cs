...
namespace NethereumUtils.Tests
{
    ...
    public class NethereumUtilsStandardTests
    {
        ...
        {
            string address = "0xb332Feee826BF44a431Ea3d65819e31578f30446";
            decimal balance = await WalletUtils.GetEthBalance(address);
        ...
        //    await WalletUtils.SendEth(privateKey, "0x5831819C84C05DdcD2568dE72963AC9f7e2833b6", readableEthAmount);
        //}
